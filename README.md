...
| `quota_exceeded` | `QuotaExceededError` — account-level cap hit | Do NOT retry; surface to the user with https://agentscore.com/pricing. Use `assess` response's `quota` field to monitor approach-to-cap proactively |
