...
export function buildCli() {
  ...
  cli.command('assess', {
    ...
    options: z.object({
      ...
      requireSanctionsClear: z.boolean().optional().describe('Require operator clear of NAME-based sanctions screening on their KYC identity. Wallet-address OFAC SDN screening is automatic when --signer-address is set (no flag needed).'),
